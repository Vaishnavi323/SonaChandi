...
<body>
  ...
  <div class="container-fluid  shadow-sm bg-white navbar d-flex py-lg-3  justify-content-between justify-content-lg-end align-items-center p-2">
  ...
  <a href="<?php echo site_url('AdminController/profile');?>" class=" text-dark "><i class="fa-regular  fa-user p-2 me-3 fs-4"></i></a>     
  </div>
