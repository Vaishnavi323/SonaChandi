...
<body style="background-image: url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c'); background-size: cover; background-position: center; height: 100vh; display: flex; align-items: center; justify-content: center;">
    <div class="container">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="p-4 rounded-3 shadow" style="background-color: rgba(255, 255, 255, 0.2);">
                    <form>
                        ...
                        <button type="submit" class="btn w-100 text-white fw-bold" style="background-color: #6b2d5c;">Login</button>
                    </form>
                </div>
            </div>
        </div>
