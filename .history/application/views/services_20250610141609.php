...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="position-relative rounded">
            <img src="<?php echo base_url('assets\services\services.png'); ?>" class="img-fluid rounded" style="height:600px; width:900px" alt="Hands Working on Ring">
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="content-box-header">
                            <h5 class="mb-0 text-center">Jiva Store</h5>
                        </div>
                        <!-- Body -->
