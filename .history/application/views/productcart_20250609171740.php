            ...
            <div class="col-md-6 mb-4">
                <div class="row">
                    ...
                    <div class="col-6 mb-2 text-center">
                        <img src="<?php echo base_url('assets/products/cart (1).png'); ?>" alt="Diamond Bracelet 1" class="img-fluid" style="width:200px; height:200px; object-fit:cover; ">
                    </div>
                    <div class="col-6 mb-2 text-center">
                        <img src="<?php echo base_url('assets/products/cart (3).png'); ?>" alt="Diamond Bracelet 2" class="img-fluid" style="width:120px; height:120px; object-fit:cover; ">
                    </div>
