            ...
            <div class="col-md-6 mb-4">
                <div class="row">
                    ...
                    <div class="col-6 mb-3 text-center">
                        <img src="<?php echo base_url('assets\products\cart (1).png'); ?>" alt="Diamond Bracelet 1" class="img-fluid" style="max-width: 140px;">
                    </div>
                    <div class="col-6 mb-3 text-center">
                        <img src="<?php echo base_url('assets\products\cart (3).png'); ?>" alt="Diamond Bracelet 2" class="img-fluid" style="max-width: 140px;">
                    </div>
                    <!-- Second row: Single image centered -->
                    <div class="col-12 text-center">
                        <img src="<?php echo base_url('assets\products\cart (2).png'); ?>" alt="Diamond Bracelet on Wrist" class="img-fluid" style="max-width: 300px;">
                    </div>
                </div>
            </div>
