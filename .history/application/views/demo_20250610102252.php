...
<body>
    <section class="store-section">
        <div class="container">
            <!-- Heading -->
            <h2 class="text-center mb-4" style="color: #rgba(94, 53, 142, 0.79);">Visit Our Stores</h2>
                ...
                <div class="col-md-6">
                    <div class="content-box">
                        ...
                        <div class="content-box-body">
                            ...
                            <p style="background-color: background-color: rgba(248, 239, 255, 1); padding: 10px; border-radius: 4px;">
