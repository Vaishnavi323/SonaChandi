            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-3 card-container">
                        <div class="card">
                            <img src="<?php echo base_url('assets\Home\brand\image 33.png'); ?>" class="card-img-top" alt="Jewelry Image">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 card-container">
                        <div class="card">
                            <img src="<?php echo base_url('assets\Home\brand\image 34.png'); ?>" class="card-img-top" alt="Jewelry Image">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 card-container">
                        <div class="card">
                            <img src="<?php echo base_url('assets\Home\brand\image 35.png'); ?>" class="card-img-top" alt="Jewelry Image">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 card-container">
                        <div class="card">
                            <img src="<?php echo base_url('assets\Home\brand\image 36.png'); ?>" class="card-img-top" alt="Jewelry Image">
                            <div class="card-body">
