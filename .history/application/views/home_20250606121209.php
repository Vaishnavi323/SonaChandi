...
<body>
    ...
    <section class="py-5" style="background: linear-gradient(45deg, #7542AC 0%, #FFFFFF 100%);
">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center text-md-start">
                    ...
                    <button class="btn text-white fw-5 px-4 py-2 rounded-3" style="background-color:rgb(149, 124, 178); font-weight:500;">View Collection</button>
                </div>
            </div>
        </div>
    </section>
