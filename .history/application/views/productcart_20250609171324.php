        ...
        <div class="col-md-6 mb-4">
                <div class="row g-2">
                ...
                        <div class="col-6 text-center">
                                <img src="<?php echo base_url('assets/products/cart (1).png'); ?>" alt="Image 1" class="img-fluid" style="max-height: 200px; object-fit: contain;">
                            </div>
                        <div class="col-6 text-center">
                                <img src="<?php echo base_url('assets/products/cart (1).png'); ?>" alt="Image 2" class="img-fluid" style="max-height: 200px; object-fit: contain;">
                            </div>

                        <!-- Bottom Row: One Large Image -->
                        <div class="col-12 text-center">
                                <img src="<?php echo base_url('assets/products/cart (1).png'); ?>" alt="Wrist Image" class="img-fluid" style="max-height: 400px; object-fit: contain;">
                            </div>
                    </div>
        </div>
