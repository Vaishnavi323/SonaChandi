      ...
      <div class="glass-card">
        <form>
          <div class="mb-3 text-start">
            <label for="email" class="form-label text-white ms-1">Username</label>
            <input type="email" id="email" class="form-control border-white text-white" placeholder="Email" style="border-width:2px;">
          </div>
          <div class="mb-3 text-start">
            <label for="password" class="form-label text-white ms-1">Password</label>
          ...
          <div class="register-link text-start">
            <a href="#" class="text-white ms-1">Forget Password?</a>
          </div>
        </form>
      </div>
