            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center">
                ...
                <div class="w-100 d-flex flex-column align-items-center">
                    <svg width="220" height="220" viewBox="0 0 220 220">
                        ...
                        <text x="105" y="80" text-anchor="middle" class="pie-label" fill="rgba(94, 53, 142, 1)" font-weight="bold" font-size="0.8rem">100%</text>
                        <text x="105" y="105" text-anchor="middle" class="pie-label" fill="rgba(94, 53, 142, 1)" font-weight="bold" font-size="0.8rem">Discount</text>
                        <text x="105" y="130" text-anchor="middle" class="pie-label" fill="rgba(94, 53, 142, 1)" font-size="1rem" font-weight="bold" id="discountValue">Rs. 3,500</text>
