...
<body>
    <div class="container">
        <div class="row section">
            <div class="col-md-6">
                <div class="card">
                    <img src="https://via.placeholder.com/400x300" class="card-img-top" alt="Engagement Rings">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="https://via.placeholder.com/400x300" class="card-img-top" alt="Wedding Special">
                    <div class="card-body">
