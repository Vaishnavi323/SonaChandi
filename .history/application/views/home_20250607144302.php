        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 text-center mb-3">
                    <h1 class="fw-bold" style="color: #5E358E; font-size: 3rem; background: linear-gradient(45deg, #7542AC, #FFFFFF); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
