...
<body>
    ...
    <!-- Chatbot Button -->
    <div class="position-fixed bottom-0 end-0 p-4 d-flex align-items-center">
        <img src="<?php echo base_url('assets/Home/chatbot-icon.png'); ?>" alt="Logo" class="chat-logo" style="width: 32px; height: 32px; margin-right: 10px;">
        <button class="chatbot-btn btn text-white rounded-pill d-flex align-items-center px-3 py-2" data-bs-toggle="modal" data-bs-target="#chatbotModal">
            <span class="me-2" style="background-color:rgba(28, 1, 44, 0.68);">Ask Question</span>
        </button>
    </div>
