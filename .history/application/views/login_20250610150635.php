      ...
      <div class="glass-card">
        <form>
          <div class="mb-3 text-start">
            <label for="email" class="form-label text-white ms-4 mb-1">Username</label><br>
            <input type="email" id="email" class="form-control border-white text-white mt-1" placeholder="Email" style="border-width:2px;">
          </div>
          <div class="mb-3 text-start">
            <label for="password" class="form-label text-white ms-4 mb-1">Password</label><br>
            <input type="password" id="password" class="form-control border-white text-white mt-1" placeholder="Password" style="border-width:2px;">
          </div>
          <div class="mb-3">
