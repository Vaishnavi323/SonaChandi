    ...
    <div class="container my-4">
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-6 mb-2 text-center">
                <img src="<?php echo base_url('assets/products/cart (2).png'); ?>" alt="Diamond Bracelet 2" class="img-fluid" style="max-width: 120px;">
                </div>
                <!-- Second row: one large image centered -->
                <div class="col-12 text-center">
                <img src="<?php echo base_url('assets/products/cart (3).png'); ?>" alt="Diamond Bracelet Main" class="img-fluid" style="max-width: 300px;">
                </div>
            </div>
            </div>
