        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn " data-bs-dismiss="modal" style="background-color:rgba(94, 53, 142, 0.53)">Clear</button>
                    <button type="button" class="btn style=" background-color:rgba(94, 53, 142, 0.53);"">Apply</button>
                </div>
            </div>
        </div>
