    ...
    <div id="jewelryCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="container-fluid text-center py-5" style="background: url('<?php echo base_url('assets/Home/screen2.png'); ?>') ">
            ...
            <div class="carousel-item">
                <div class="container-fluid text-center py-5" style="background: url('<?php echo base_url('assets/Home/screen1.png'); ?>') ">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-12">
                            <h1 class="display-4 text-white fw-bold">Golden Edit</h1>
            ...
            <!-- Slide 3 -->
            <div class="carousel-item">
                <div class="container-fluid text-center py-5" style="background: url('<?php echo base_url('assets/Home/screen3.png'); ?>')">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-12">
                            <h1 class="display-4 text-white fw-bold">Golden Edit</h1>
