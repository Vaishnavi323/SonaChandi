    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-lg-2-4 col-md-2-4 col-6" style="flex: 0 0 20%; max-width: 20%;">
                <div class="coin-card" style="border: none; text-align: left;">
                    <img src="<?php echo base_url('assets\products\goldcoin.png'); ?>" alt="Gold Coin" class="coin-img">
                    <div>
                        <span>2 gram 24 KT</span><span style="float: right;">Rs. 20,089</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-2-4 col-md-2-4 col-6" style="flex: 0 0 20%; max-width: 20%;">
                <div class="coin-card" style="border: none; text-align: left;"></div>
                    <img src="<?php echo base_url('assets\products\goldcoin.png'); ?>" alt="Gold Coin" class="coin-img">
                    <div>
