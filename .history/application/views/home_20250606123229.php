...
">
        <div class="container">
            <h2 class="fw-bold mb-5 text-center">Bracelet Collection</h2>
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center text-md-start">
                    ...
                    <button class="btn text-white fw-5 px-4 py-2 rounded-3" style="background-color: #5E358E; font-weight:500;">View Collection</button>
                </div>
            </div>
        </div>
    </section>
