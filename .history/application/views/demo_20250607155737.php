        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            ...
            <div class="col">
                    <div class="card border-0 text-center">
                            <img src="<?php echo base_url('assets/products/product (1).png'); ?>" class="img-fluid " alt="Twisted Ring">
                            
                                    <h6 class="card-title  fw-normal text-dark">Twisted Ring</h6>
                                    <p class="card-text " style="color: #B084CC;">$320</p>
                                </div>
                        </div>
            </div>
