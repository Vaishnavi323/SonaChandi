        ...
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-4 col-md-2 mb-4">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark ">Rings</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark">Nose Pins</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark">Earring</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark ">Bangles</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark">Necklace</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                    ...
                    <p class="mt-2 text-center fw-bold text-dark">Anklet</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row section align-items-center">
                ...
                <div class="col-md-6">
                    <h5 class="section-title mb-4" style="color:rgba(66, 10, 92, 0.76);">Engagement Rings Collection</h5>
                    <p>
            ...
            <div class="row section align-items-center">
                ...
                <div class="col-md-6 order-md-1">
                    <h5 class="section-title mb-4">Wedding Special Collection</h5>
                    <p>
                        Lorem ipsum dolor sit amet consectetur. In purus vitae rutrum risus et fringilla phasellus ipsum eget. Id sagittis ac turpis ultrices non. Ultrices eu sit faucibus turpis. Mi suspendisse aliquet augue purus mauris egestas pharetra in nulla. Viverra.
                    </p>
                    <div class="d-flex justify-content-center">
