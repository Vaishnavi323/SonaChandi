...
<body>
    ...
    <div class="modal fade" id="chatbotModal" tabindex="-1" aria-labelledby="chatbotModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-end modal-dialog-scrollable" style="max-width: 400px; min-width: 350px; min-height: 520px;">
            <div class="modal-content" style="height: 520px;">
                ...
                <div class="modal-body chat-body" style="max-height: 340px;">
    ...
    <style>
        /* Custom modal to appear on right side and bigger size */
