...
<body>
    ...
    <div class="container my-4">
            ...
            <div class="col-12 col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class=" breadcrumb-item"><a href="<?php echo base_url('User/goldcoins'); ?>">Gold Coins</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="fw-bold" style="font-family: 'Cormorant Garamond', serif; color: #420A5C !important;">2 Gram 24 KT Gold Coin</h2>
