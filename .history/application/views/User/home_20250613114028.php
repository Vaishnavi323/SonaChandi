...
<body>
    ...
    <div id="carouselExample" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2500">
            <div class="carousel-inner">
                    <div class="carousel-item active">
                            <img src="<?php echo base_url('assets/Home/screen1.png'); ?>" class="d-block w-100 carousel-img" alt="screen1">
                        </div>
                    <div class="carousel-item">
                            <img src="<?php echo base_url('assets/Home/screen2.png'); ?>" class="d-block w-100 carousel-img" alt="screen2">
                        </div>
                    <div class="carousel-item">
                            <img src="<?php echo base_url('assets/Home/screen3.png'); ?>" class="d-block w-100 carousel-img" alt="screen3">
                        </div>
                </div>
    ...
    <div class="position-fixed bottom-0 end-0 p-4">
        <button class="chatbot-btn btn text-white rounded-pill d-flex align-items-center px-3 py-2" data-bs-toggle="modal" data-bs-target="#chatbotModal">
            <img src="<?php echo base_url('assets/Home/chatbot-icon.png'); ?>" alt="Logo" class="chat-logo" style="width: 24px; height: 24px; margin-right: 8px;">
            ...
            <div class="row justify-content-center">
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (6).png'); ?>" class=" cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Rings">
                    </div>
                    <p class="mt-2 text-center text-dark ">Rings</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (5).png'); ?>" class="cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Nose Pins">
                    </div>
                    <p class="mt-2 text-center text-dark">Nose Pins</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (1).png'); ?>" class="cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Earring">
                    </div>
                    <p class="mt-2 text-center text-dark">Earring</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (2).png'); ?>" class="cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Bangles">
                    </div>
                    <p class="mt-2 text-center  text-dark ">Bangles</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (3).png'); ?>" class="cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Necklace">
                    </div>
                    <p class="mt-2 text-center text-dark">Necklace</p>
                </div>
                <div class="col-4 col-md-2 mb-4">
                    <div style="width: 100px; height: 100px; margin: 0 auto;">
                        <img src="<?php echo base_url('assets/Home/catloge/image (4).png'); ?>" class="cat-img-zoom rounded-circle w-100 h-100" style="object-fit: cover;" alt="Anklet">
                    </div>
