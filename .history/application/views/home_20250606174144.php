...
<body>
    ...
    <section>
        <div class="container py-5">
            <h2 class="text-center section-title brand-store mb-5 fw-bold">Brand Store</h2>
            <div class="row g-4 align-items-center justify-content-center">
                <div class="col-md-6 d-flex justify-content-center">
                    <div class="bg-white rounded-4 shadow-sm p-3 w-100" style="max-width: 400px;">
                        <img src="<?php echo base_url('assets/Home/brand/brand1.png'); ?>" class="img-fluid rounded-3 w-100" alt="Shaya Jewelry">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row g-4">
                        <div class="col-12 d-flex justify-content-center">
                            <div class="bg-white rounded-4 shadow-sm p-3 w-100" style="max-width: 400px;">
                                <img src="<?php echo base_url('assets/Home/brand/brand2.png'); ?>" class="img-fluid rounded-3 w-100" alt="Everyday Jewelry 1">
                            </div>
                        </div>
                        <div class="col-12 d-flex justify-content-center">
                            <div class="bg-white rounded-4 shadow-sm p-3 w-100" style="max-width: 400px;">
                                <img src="<?php echo base_url('assets/Home/brand/brand3.png'); ?>" class="img-fluid rounded-3 w-100" alt="Everyday Jewelry 2">
                            </div>
                        </div>
                    </div>
                </div>
