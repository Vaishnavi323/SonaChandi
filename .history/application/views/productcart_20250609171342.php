            ...
            <div class="col-md-6 mb-4">
                <div class="row">
                    <div class="col-12 mb-3 text-center">
                        <img src="<?php echo base_url('assets\products\cart (1).png'); ?>" alt="Diamond Bracelet" class="img-fluid" style="max-width: 300px;">
                    </div>
                    <div class="col-12 text-center">
                        <img src="<?php echo base_url('assets\products\cart (1).png'); ?>" alt="Diamond Bracelet on Wrist" class="img-fluid" style="max-width: 300px;">
                    </div>
                </div>
            </div>
