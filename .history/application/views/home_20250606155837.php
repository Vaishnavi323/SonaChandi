...
<body>
    ...
    <section class="py-5" style="background-color: #E6D6F5;">
        <div class="container">
            <div class="row align-items-center">
                <!-- Heading -->
                <div class="col-12 text-md-start mb-5">
                    <h1 class="fw-bold" style="color: #5E358E; font-size: 3rem;">Celebrate Women's<br> Happiness</h1>
                </div>
                <!-- Images and Text -->
                ...
                <div class="col-md-4 text-center text-md-start">
                    ...
                    <p class="mb-4 mt-5" style="color: #5E358E;">
                        Celebrate your unique style with our exquisite women's jewellery collection. From timeless gold and diamond pieces
                    </p>
                    <div class="d-flex justify-content-center">
                        <button class="btn text-white px-4 py-2 rounded-3 shadow-custom" style="background-color: #5E358E;">Explore Now</button>
                    </div>
                    <style>
                        .shadow-custom {
                            box-shadow: 4px 8px 20px 0 rgba(94, 53, 142, 0.25);
                        }
                    </style>
                </div>
            </div>
