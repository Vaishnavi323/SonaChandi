    ...
    <div class="container my-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" class="text-muted text-decoration-none">Gold Coins</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div>
                    <button type="button" class="btn btn-link text-muted text-decoration-none p-0" style="font-size: 1.2rem;" onclick="this.classList.toggle('text-danger')">
                        <span class="me-1" style="font-size: 1.3em;">&#9829;</span>Save to Wishlist
                    </button>
                </div>
            </div>
        </div>
