...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            <!-- Product Card 1 -->
            <div class="col">
                    <div class="card product-card border-0 shadow-sm"> <!-- Removed default border -->
                    ...
                            <div class="card-body p-2"> <!-- Reduced padding -->
                                    <h6 class="card-title m-0">TWISTED RING</h6>
                                    <p class="card-text text-primary mb-0">$320</p> <!-- Removed bottom margin -->
                                </div>
                        </div>
            </div>
