    ...
    <div class="container my-4">
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="row">
                    <!-- First row: Two images side by
                        <img src="https://via.placeholder.com/300x300.png?text=Diamond+Bracelet" alt="Diamond Bracelet" class="img-fluid" style="max-width: 300px;">
                    </div>
