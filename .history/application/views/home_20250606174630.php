    ...
    <section>
        <div class="container py-5">
            ...
            <div class="row g-4 align-items-center justify-content-center">
                ...
                <div class="col-md-4 d-flex justify-content-center">
                    <img src="<?php echo base_url('assets/Home/brand/image 54.png'); ?>" class="img-fluid shadow" alt="Brand 2" style="max-width: 100%; height: auto;">
                </div>
                <div class="col-md-4 d-flex justify-content-center">
                    <img src="<?php echo base_url('assets/Home/brand/image 54.png'); ?>" class="img-fluid shadow" alt="Brand 3" style="max-width: 100%; height: auto;">
                </div>
            </div>
        </div>
    </section>
