...
<head>
    ...
    <style>
        ...
        .dropdown-toggle {
            background: #fff;
            border: 1.5px solid #b53fc2;
            color: #b53fc2;
            border-radius: 2rem;
            min-width: 120px;
            font-weight: 600;
            box-shadow: 0 1px 5px rgba(156, 96, 221, 0.05);
        }
        ...
        /* Make Add to Cart always at card bottom */
        .card-body {
            display: flex;
            flex-direction: column;
...
<body class="bg-light">
    ...
    <div class="container my-4">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 mt-1">
            <!-- Example Product Card (repeat for all products) -->
            <div class="col">
                <div class="card product-card border-0 shadow-sm h-100 d-flex flex-column">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="add-to-cart-box w-100">
                            <button class="btn add-to-cart-btn w-100 shadow" style="font-size: 1rem;">Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Repeat above card for each product, just change image src as needed -->
            <div class="col">
                <div class="card product-card border-0 shadow-sm h-100 d-flex flex-column">
                    <div class="discount-banner">Flat 20% Discount</div>
    ...
    <!-- Bootstrap JS (must be at the end for dropdown to work!) -->
