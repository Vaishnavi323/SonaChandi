...
<head>
    ...
    <style>
        ...
        .section1 {
            min-height: 60vh;
            background: url("<?php echo base_url('assets/services/installment.png'); ?>") no-repeat left center;
...
<body>
    ...
    <div class="container-fluid px-0" style="max-width: 1400px;">
        <div class="section1 position-relative w-100" style="background-image: url('YOUR_RING_IMAGE_URL_HERE');">
            ...
            <div class="col-12 col-lg-6 d-flex flex-column align-items-center">
                ...
                <div class="w-100 d-flex flex-column align-items-center">
                    <svg width="220" height="220" viewBox="0 0 220 220">
                        ...
                        <text x="105" y="80" text-anchor="middle" class="pie-label" fill="#7c37a6" font-weight="bold" font-size="1.1rem">100%</text>
                        <text x="105" y="105" text-anchor="middle" class="pie-label" fill="#7c37a6" font-weight="bold" font-size="1.1rem">Discount</text>
                        ...
                        <text x="110" y="180" text-anchor="middle" fill="#fff" font-size="1.05rem" font-weight="bold">You Pay</text>
                        <text x="110" y="198" text-anchor="middle" fill="#fff" font-size="1.02rem" font-weight="bold" id="youPayText">Rs. 35,000</text>
                    </svg>
                </div>
            </div>
            <!-- Results -->
