...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="<?php echo base_url('assets\Home\brand\image 36.png'); ?>" alt="Logo"></a>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            ...
            <div class="col">
                <div class="card product-card">
                    <img src="<?php echo base_url('assets\Home\brand\image 36.png'); ?>" class="card-img-top" alt="Twisted Ring">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card product-card">
                    <img src="https://via.placeholder.com/200" class="card-img-top" alt="Twisted Ring">
                    <div class="card-body">
                        <h6 class="card-title">TWISTED RING</h6>
                        <p class="card-text text-primary">$320</p>
                    </div>
