...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12 space-between d-flex justify-content-md-end">
                <div class="dropdown me-2">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="filter-modal" data-bs-toggle="dropdown">
                        FILTER BY
                    </button>
