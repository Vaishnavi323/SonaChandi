        ...
        <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
            ...
            <div class="col">
                <div class="card h-100 border-0 text-center">
                    <img src="<?php echo base_url('assets\services\services.png'); ?>" class="card-img-top mx-auto rounded" alt="Schedule Video Call" style="max-width: 300px;">
            ...
            <div class="col">
                <div class="card h-100 border-0 text-center">
                    <img src="<?php echo base_url('assets\services\services.png'); ?>" class="card-img-top mx-auto rounded" alt="Book Visit" style="max-width: 300px;">
                    <div class="card-body p-0">
