  ...
  <section class="main" style="background-image: url('<?php echo base_url("assets/Home/loginbackground.jpg"); ?>');">
    ...
    <div class="content-box mx-2">
      ...
      <form>
        ...
        <p class="text-secondary mb-4" style="font-size: 1rem;">Please enter your credentials to continue.</p>
        <div class="mb-3">
        <label for="email" class="form-label text-white fw-bold ms-4 mb-1" style="font-size: 1.1rem;">Username</label>
        <div class="d-flex justify-content-center">
          <input type="email" id="email" class="form-control border-white text-white" placeholder="Email" style="border-width:2px;">
        </div>
        </div>
        <div class="mb-3">
        <label for="password" class="form-label text-white fw-bold ms-4 mb-1" style="font-size: 1.1rem;">Password</label>
        <div class="d-flex justify-content-center">
