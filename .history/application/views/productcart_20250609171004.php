    ...
    <div class="container my-4">
        <div class="row">
            ...
            <div class="col-md-6 mb-4 d-flex flex-column align-items-center">
                <div class="d-flex w-100 mb-2" style="gap: 2;">
                    <img src="<?php echo base_url('assets/products/cart (1).png'); ?>" alt="Diamond Bracelet 1" class="img-fluid" style="max-width: 140px; width: 50%;">
                    <img src="<?php echo base_url('assets/products/cart (3).png'); ?>" alt="Diamond Bracelet 2" class="img-fluid" style="max-width: 140px; width: 50%;">
                </div>
                <div class="w-100 text-center">
                    <img src="<?php echo base_url('assets/products/cart (2).png'); ?>" alt="Diamond Bracelet on Wrist" class="img-fluid" style="max-width: 300px; width: 100%;">
                </div>
            </div>

            <!-- Right: Product Details -->
            <div class="col-md-6">
                <h2 class="fw-bold">Diamond Bracelet</h2>
