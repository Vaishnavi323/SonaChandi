...
<head>
    ...
    <style>
        ...
        .category-card:hover {
            ...
            box-shadow: 0 4px 15px rgba(181, 63, 194, 0.3);
        }
        ...
        /* Show cards on click for Trending */
        #trendingCards:target {
            display: block;
            opacity: 1;
            transform: translateX(-50%) translateY(0);
        }

        /* Show cards on hover for Mangalsutras */
        .nav-item.dropdown:hover .category-cards {
            display: block;
            opacity: 1;
            transform: translateX(-50%) translateY(0);
        }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3" href="#trendingCards">Trending</a>
                        <div class="category-cards" id="trendingCards">
                            <div class="d-flex justify-content-between align-items-center position-relative">
                                <a class="carousel-control-prev" href="#" role="button">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </a>
                                <a href="#" class="category-card mx-2">
                                    <img src="https://via.placeholder.com/150" alt="Layered">
                                    <p>Layered</p>
                                </a>
                                <a href="#" class="category-card mx-2">
                                ...
                                <a href="#" class="category-card mx-2">
                                    <img src="https://via.placeholder.com/150" alt="Traditional">
                                    <p>Traditional</p>
                                </a>
                            ...
                            <button class="ask-question-btn"><i class="bi bi-question-circle"></i> Ask a Question</button>
                        </div>
                        </li主要
