        ...
        <div class="container py-5">
            ...
            <div class="row g-4 align-items-center justify-content-center">
                <div class="col-md-6 d-flex justify-content-center">
                    <img src="<?php echo base_url('assets/Home/brand/brand1.png'); ?>" class="img-fluid rounded-3 shadow" alt="Shaya Jewelry" style="max-width: 100%; height: auto;">
                </div>
                <div class="col-md-6">
                    <div class="row g-4">
                        <div class="col-12">
                            <img src="<?php echo base_url('assets/Home/brand/brand2.png'); ?>" class="img-fluid rounded-3 shadow" alt="Everyday Jewelry" style="width: 100%; height: auto;">
                        </div>
                        <div class="col-12">
                            <img src="<?php echo base_url('assets/Home/brand/brand3.png'); ?>" class="img-fluid rounded-3 shadow" alt="Special Jewelry" style="width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
            </div>
