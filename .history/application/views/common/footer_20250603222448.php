                        ...
                        <div class="mangalsutra-cards">
                            <div class="d-flex justify-content-between align-items-center position-relative">
                                ...
                                <div class="mangalsutra-card mx-2">
                                    <img src="<?php echo base_url('assets/navbar/Mangalsutras/ButterflyCollection.png'); ?>" alt="Layered">
                                    <p>Layered</p>
                                </div>
                                <div class="mangalsutra-card mx-2">
                                    <img src="<?php echo base_url('assets/navbar/Mangalsutras/infinitychain.png'); ?>" alt="Modern">
                                    <p>Modern</p>
                                </div>
                                <div class="mangalsutra-card mx-2">
                                    <img src="<?php echo base_url('assets/navbar/Mangalsutras/ring.png'); ?>" alt="Traditional">
                                    <p>Traditional</p>
                                </div>
