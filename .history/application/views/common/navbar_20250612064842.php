        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link px-3" href="<?php echo base_url('User/home'); ?>">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="<?php echo base_url('User/aboutus'); ?>">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="<?php echo base_url('User/collections'); ?>">Collections</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="<?php echo base_url('User/goldcoins'); ?>">Gold Coin</a>
                    </li>
                </ul>
                <!-- Right Nav Item (Services Dropdown) -->
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="servicesDropdown">
                            <li><a class="dropdown-item" href="<?php echo base_url('User/services/repair'); ?>">Jewellery Repair</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('User/services/custom'); ?>">Custom Design</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('User/services/exchange'); ?>">Gold Exchange</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('User/services/appraisal'); ?>">Appraisal</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
