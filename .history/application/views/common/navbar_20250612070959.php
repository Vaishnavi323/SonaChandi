...
<head>
    ...
    <style>
        ...
        /* Dropdown for Mangalsutras (hidden on desktop for now, could expand later with JS/Bootstrap) */
    </style>
</head>
    ...
    <div class="bg-white border-bottom py-1">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center">
                <a href="#" class="icon-btn px-2"><i class="bi bi-heart"></i></a>
                <a href="#" class="icon-btn px-2"><i class="bi bi-cart"></i></a>
                <a href="#" class="icon-btn px-2"><i class="bi bi-person"></i></a>
            </div>
        </div>
    </div>
