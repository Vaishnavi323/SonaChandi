...
<body>
    ...
    <!-- Gold Rates Marquee Bar -->
    <div class="bg-gradient-gold-rates py-1 border-bottom">
        <div class="container-fluid d-flex align-items-center">
            <i class="bi bi-currency-dollar me-2" style="color: #b53fc2; font-size: 1.2rem;"></i>
            <strong class="me-2" style="color: #fff; letter-spacing: 1px;">Daily Gold Rates:</strong>
            <marquee behavior="scroll" direction="left" scrollamount="6" class="flex-grow-1" style="color: #fff; font-weight: 500;">
                24K Gold: ₹6,120/gm &nbsp;&nbsp; | &nbsp;&nbsp; 22K Gold: ₹5,610/gm &nbsp;&nbsp; | &nbsp;&nbsp; Silver: ₹75/gm &nbsp;&nbsp; | &nbsp;&nbsp; Updated: 12 June 2025
            </marquee>
        </div>
    </div>
