...
<body>
    ...
    <div class="bg-white border-bottom py-1">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <form class="search-bar d-flex mx-3" style="max-width:350px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-white px-3 dropdown-toggle" href="#" id="servicesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu  text-white dropdown-menu-start" aria-labelledby="servicesDropdown">
                            <li><a class="dropdown-item" href="<?php echo base_url('User/demo'); ?>">Schemes</a></li>
