...
<body>
    ...
    <div class="fixed top-0 left-0 right-0 z-[999]">
        <div class="bg-white border-b-2 border-slate-400">
            <div class="w-full overflow-hidden">
                <div class="w-full text-primary font-bold">
                    <div class="w-full overflow-hidden">
                        <div class="scrolling-text-wrapper" id="stockData">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="gold-rates-bar">
            <div class="container-fluid d-flex align-items-center">
                <div class="rates-header">
                    ...
                    <span>Daily Precious Metal Rates</span>
                </div>
