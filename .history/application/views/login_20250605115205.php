...
<body style="background-image: url('<?php echo base_url('assets\Home\loginbackground.jpg'); ?>'); background-size: cover; background-position: center; height: 100vh; display: flex; align-items: center; justify-content: center;">
    <div class="container">
