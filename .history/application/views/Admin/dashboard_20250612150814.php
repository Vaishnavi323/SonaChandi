                        ...
                        <div class="row" >
                            <div class="col-md-4" >
                                <div class="card p-2 text-center top-box">
                                    <div class="row">
                                        <div class="col-md-4"> 
                                            <img class="img-fluid" src="<?php echo base_url("assets/images/orders.png"); ?>" alt="">
                                        </div>
                                        <div class="col-md-8">
                                            <h6>Total Orders</h6>
                                            <h2>75</h2>
                             ...
                             <div class="col-md-4" >
                                <div class="card p-2 text-center top-box">
                                    <div class="row">
                                        <div class="col-md-4">
                                             <img class="img-fluid" src="<?php echo base_url("assets/images/clients.png"); ?>" alt="">
                                        </div>
                                        <div class="col-md-8">
                                            <h6>Total Clients</h6>
                                            <h2>42</h2>
                             ...
                             <div class="col-md-4" >
                                <div class="card p-2 text-center top-box">
                                    <div class="row">
                                        <div class="col-md-4 ">
                                             <img class="img-fluid " src="<?php echo base_url("assets/images/deliverd.png"); ?>" alt="">
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card text-center">
                                            <div class="avatar mx-auto my-1"> <img src="<?php echo base_url("assets/images/Avatar.png"); ?>" alt=""></div>
      ...
      <button class="btn "><i class="fa-solid fa-plus fs-5 rounded "></i></button>
                        ...
                        <div class="card p-3 ">
                            <div class="card mb-2 p-1">
                                <div class="row">
                                    <div class="col-md-3"><img class="img-fluid " src="<?php echo base_url("assets/images/person.png"); ?>" alt=""></div>
