         ...
         <a href="<?php echo base_url('Welcome/addproduct'); ?> " class="btn "><i class="fa-solid fa-plus fs-5 rounded"></i></a>
          ...
          <table class="table text-center   table-condensed table-borderless rounded align-middle">
            ...
            <tbody>
              <tr>
                <td>12ES</td>
                <td><img src="<?php echo base_url('assets/images/pearl.png'); ?>" alt="Product" width="60" height="60"
...
<div class="row">
 ...
 <div class=" col-md-12">
        ...
        <img src="<?php echo base_url("assets/images/pearl.png"); ?>" alt="Product Image" style="height: 80px;" class="border rounded">
      </div>
