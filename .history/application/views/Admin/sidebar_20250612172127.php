...
<nav class=" text-white  h-100">
  ...
  <ul class="nav flex-column">
    ...
    <li class="nav-item"><a href="<?php echo site_url('AdminController/dashboard');?>" class="nav-link text-dark "><i class="pe-2 mr-2 fas text-dark fa-chart-line"></i>Dashboard</a></li>
    <li class="nav-item"><a href="<?php echo site_url('AdminController/product');?>" class="nav-link text-dark "><i class="pe-2 mr-2 fas text-dark fa-box"></i>Product</a></li>
    <li class="nav-item"><a href="<?php echo site_url('AdminController/orders');?>" class="nav-link text-dark "><i class="pe-2 mr-2 fas text-dark fa-cart-shopping"></i>Orders</a></li>
    <li class="nav-item"><a href="<?php echo site_url('AdminController/rating');?>" class="nav-link text-dark "><i class="pe-2 mr-2 fas text-dark fa-comment-dots"></i>Reviews</a></li>
    <li class="nav-item"><a href="<?php echo site_url('AdminController/cust');?>" class="nav-link text-dark "><i class="pe-2 mr-2 fas text-dark fa-user-group"></i>Customers</a></li>
